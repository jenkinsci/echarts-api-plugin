...
image:https://github.com/jenkinsci/echarts-api-plugin/workflows/CI%20on%20all%20platforms/badge.svg?branch=master[GitHub Actions, link=https://github.com/jenkinsci/echarts-api-plugin/actions]
